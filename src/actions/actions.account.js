...
export const fetchPeaks = () => {
  return dispatch => {
    ...
    return axios
      ...
      .catch(error => {
        dispatch({ type: types.PEAK_ERROR, payload: error.response });
      });
  };
};
...
export const updateUserProfileRequest = (profile, userID) => {
  return dispatch => {
    ...
    return axios
      .put(`${API_URL}/users/${userID}`, profile)
      .then(response => {
...
export const addNewGoal = (userID, peak) => {
  return dispatch => {
    ...
    return axios
      .post(`${API_URL}/users/${userID}/peaks`, peak)
      .then(response => {
        dispatch({
          type: types.CREATE_USER_GOAL_SUCCESS,
          payload: response.data
        });
      })
      .catch(error => {
        dispatch({
          type: types.CREATE_USER_GOAL_ERROR,
          payload: error.response
        });
      });
  };
...
export const removeUserGoal = (userID, request) => {
  return dispatch => {
    ...
    return axios
      .delete(`${API_URL}/users/${userID}/peaks`, { data: request })
      .then(response => {
        dispatch({ type: types.DELETE_USER_GOAL_SUCCESS });
      })
      .catch(error => {
        dispatch({
          type: types.DELETE_USER_GOAL_ERROR,
          payload: error.response
        });
      });
  };
...
export const updateUserGoal = (userID, request) => {
  return dispatch => {
    ...
    return axios
      .put(`${API_URL}/users/${userID}/peaks`, request)
      .then(response => {
        dispatch({ type: types.UPDATE_USER_GOAL_SUCCESS });
      })
      .catch(error => {
        dispatch({
          type: types.UPDATE_USER_GOAL_ERROR,
          payload: error.response
        });
      });
  };
