          ...
          <div>
            <form onSubmit={this.updateGoal.bind(this)}>
              <TextField
                ...
                onChange={event =>
                  this.props.updateGoalForm({
                    property: "account_rating",
              ...
              <div className="button-wrapper">
                ...
                <button type="submit" className="edit-goal-button">
                  COMPLETE
                </button>
              </div>
            </form>
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators(
    { removeUserGoal, updateUserGoal, updateGoalForm },
    dispatch
  );
};
